...
const Navbar = () => {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-300 font-display ${scrollPosition > 20 ? "h-[70px] shadow-md" : "h-[90px]"
        }`}
      style={{
            ...
            <div className="flex items-center space-x-6 xl:space-x-10">
                ...
                {openDropdown === 'acab' && (
                  <div className="absolute left-0 mt-2 w-48 bg-[rgba(20,20,20,0.98)] rounded shadow-lg border border-gray-800 z-50">
                    <div className="flex flex-col py-2">
                      <Link href="/tribes" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/tribes' ? getNavAccentColor('/tribes') : undefined,
                          color: hoveredLink === '/tribes' ? '#222' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/tribes')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Tribus</Link>
                      <Link href="/characters" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/characters' ? getNavAccentColor('/characters') : undefined,
                          color: hoveredLink === '/characters' ? '#fff' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/characters')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Personnages</Link>
                      <Link href="/map" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/map' ? getNavAccentColor('/map') : undefined,
                          color: hoveredLink === '/map' ? '#fff' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/map')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Carte</Link>
                      <Link href="/legends" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/legends' ? getNavAccentColor('/legends') : undefined,
                          color: hoveredLink === '/legends' ? '#fff' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/legends')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Légendes</Link>
                      <Link href="/world" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/world' ? getNavAccentColor('/world') : undefined,
                          color: hoveredLink === '/world' ? '#222' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/world')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Monde</Link>
                    </div>
                  </div>
              ...
              <div className="relative dropdown-container">
                ...
                {openDropdown === 'kabila' && (
                  <div className="absolute left-0 mt-2 w-48 bg-[rgba(20,20,20,0.98)] rounded shadow-lg border border-gray-800 z-50">
                    <div className="flex flex-col py-2">
                      <Link href="/ecologie" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/ecologie' ? '#4A9D3D' : undefined,
                          color: hoveredLink === '/ecologie' ? '#fff' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/ecologie')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Écologie</Link>
                      <Link href="/histoire" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/histoire' ? '#E3A947' : undefined,
                          color: hoveredLink === '/histoire' ? '#222' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/histoire')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Histoire</Link>
                      <Link href="/humanite" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/humanite' ? '#1C6E5F' : undefined,
                          color: hoveredLink === '/humanite' ? '#fff' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/humanite')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Humanité</Link>
                      <Link href="/economie" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/economie' ? '#C73E3A' : undefined,
                          color: hoveredLink === '/economie' ? '#fff' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/economie')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Économie</Link>
                      <Link href="/politique" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/politique' ? '#9C4DC4' : undefined,
                          color: hoveredLink === '/politique' ? '#fff' : undefined
                        }}
                        onMouseEnter={() => setHoveredLink('/politique')}
                        onMouseLeave={() => setHoveredLink(null)}
                      >Politique</Link>
                      <Link href="/team" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/team' ? '#39C9C9' : undefined,
                          color: hoveredLink === '/team' ? '#222' : undefined
                        }}
                      ...
                      <Link href="/contact" onClick={() => setOpenDropdown(null)}
                        className="px-4 py-3 text-gray-300 transition-colors duration-200"
                        style={{
                          backgroundColor: hoveredLink === '/contact' ? '#64afd6' : undefined,
                          color: hoveredLink === '/contact' ? '#fff' : undefined
                        }}
